...
class ulp_widget extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		if (!empty($html)) {
			$content = $args['before_widget'].'<div style="max-width:'.$instance['width_max'].'px; margin:'.$instance['margin_top'].'px '.$instance['margin_right'].'px '.$instance['margin_bottom'].'px '.$instance['margin_left'].'px;">'.$html.'</div>'.$args['after_widget'];
		}
		echo $content;
	}
